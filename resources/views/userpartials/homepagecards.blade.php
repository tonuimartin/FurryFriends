	...
	<div class="container py-4">
		...
		<article class="postcard dark blue">
			<a class="postcard__img_link" href="#">
				<img class="postcard__img" src="{{asset('images/dog.jpeg')}}" alt="Image Title" />
			</a>
			<div class="postcard__text">
				...
				<div class="postcard__preview-txt">Welcome! Thank you for using the most reliable source to acquire your pets</div>
