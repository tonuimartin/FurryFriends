	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="POST" action="/pet/{{ $pet->pet_id }}/update" enctype="multipart/form-data" class="login100-form validate-form">
                @csrf
                @method('PUT')
					<div class="wrap-input100 validate-input m-b-26" data-validate="Pet Name is required">
						<span class="label-input100">Pet Name</span>
						<input class="input100" type="text" name="pet_name" placeholder="Enter Pet Name" value="{{$pet->pet_name}}">
                    ...
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Pet Age is required">
						...
						<input class="input100" type="number" name="age" placeholder="Enter Pet Age" value="{{$pet->age}}">
						<span class="focus-input100"></span>
					</div>
                    ...
                    <option value="{{$pet->pet_gender}}">-select-</option>
                    ...
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Pet Breed is required">
						...
						<input class="input100" type="text" name="breed" placeholder="Enter Pet Breed" value="{{$pet->breed}}">
						<span class="focus-input100"></span>
					</div>
                    ...
                    value="{{$pet->pet_type}}">
                    <option value="{{$pet->pet_type}}">-select-</option>
